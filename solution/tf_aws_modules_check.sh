...
# "arn:aws:ec2:eu-central-1" - means, that real resource created in AWS
...
if [ $(grep -E -w 'ec2_ami|ec2_public_ip|ec2_type|arn:aws:ec2:eu-central-1|vpc_id|subnet_id|security_group_ids' result_example | wc -l) -eq 8 ]; then
   exit_code=0
fi
